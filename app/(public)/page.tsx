      ...
      <section id="packs" className="py-20 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          {settings.discountRate > 0 && (
            <div className="flex items-center justify-center gap-2 mb-8 px-5 py-2.5 bg-blue-50 border border-blue-200 rounded-lg text-sm font-semibold text-blue-700 max-w-sm mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-colors text-sm"
            >
